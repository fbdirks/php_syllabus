...
<?php
	...
	$geshi->load_from_file("wijzig1.php");
...
<?php
$code = '<input type="text" name="region">
';
toon_code($code);
?>
<p>We voegen aan deze tag een 'value' onderdeel toe:</p>
<?php
$code = '<input type="text" name="region" value=" ">
';
toon_code($code);
?>
...
<?php
$code = '<input type="text" name="region" value="<?php echo $region; ?>">
';
toon_code($code);
?>
...
<?php
$code = '<input type="text" name="region" value="Europe">
';
toon_code($code);
?>
...
<?php
$code = '<form action="verwerk_wijziging.php" method="post">
...
<?php
	$code = '';
	$geshi = new GeSHi($code, 'php');
	$geshi->load_from_file("verwerk_wijziging.php");
...
<?php
	$code = '';
	$geshi = new GeSHi($code, 'php');
	$geshi->load_from_file("wijzig_land.php");
