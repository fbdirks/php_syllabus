...
?>
	<div class="useradd">
		...
		<div class="useradd_formulier">
			<form action="sk_useradd.php" method="post">
			Usernaam:<br>
		...
		<a href="sk_pagina1.php">terug naar pagina1</a>
		</div>
		<h2>De Userlijst:</h2>
...
if (isset($_POST['toevoegen'])) {
	...
	if ($doorgaan) {
		...
		$nieuwe_lijst = fopen('sk_users.csv','a') or die ("userlijst niet aanwezig");
...
// Userlijst laten zien:
		...
		$lijst = fopen('sk_users.csv','r') or die("Geen usergegevens"); # lijst openen voor lezen alleen.
