...
<pre><code class="language-php">$mysql = mysqli_connect($db_server, $db_user, $db_password, $db_name);</code></pre>
...
<pre><code class="language-php">$code = 'include "db_gegevens.php";</code></pre>
...
<pre><code class="language-php">$code = '$query = "SELECT * FROM bbc WHERE region = \'Europe\'";</code></pre>
<p></p>
...
<pre><code class="language-php">$code = '$resultaat = mysqli_query($mysql,$query);
...
<pre><code class="language-php">while ($rij = mysqli_fetch_row($resultaat)) {
 echo "<tr>";
 foreach ($rij as $veld) {
	echo "<td>$veld</td>";
 }
...
<pre><code class="language-php">$code = 'mysqli_close($mysql);</code></pre>
...
<pre data-src="europa.hph"><code class="language-php"></code></pre>
