...
<?php
$code = '$mysql = mysqli_connect($db_server, $db_user, $db_password, $db_name) or die ("Mysql server kan niet bereikt worden";';
toon_code($code);
?>
...
<?php
$code = '$resultaat = mysqli_query($mysql,$query) or die ("Query kon niet uitgevoerd worden";';
toon_code($code);
?>
...
<?php
$code = '$resultaat = mysqli_query($mysql,$query) or die ("Query kon niet uitgevoerd worden: ".mysqli_error($mysql);';
toon_code($code);
?>
